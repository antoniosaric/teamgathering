...
try {
    ...
    $sql = "SELECT DISTINCT profiles.image, profiles.first_name, profiles.last_name, messages.sender_id, messages.recipient_id 
    ...
    $sql2 = "SELECT DISTINCT profiles.image, profiles.first_name, profiles.last_name, messages.sender_id, messages.recipient_id 
