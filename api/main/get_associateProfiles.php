...
try {
    ...
    WHERE profiles_team.team_id IN ( 
        ...
        FROM profiles_team 
        WHERE profiles_team.profile_id = ".$profile_id." ) AND profiles.profile_id != ".$profile_id." AND profiles_team.profile_team_status != 'deleted' ORDER BY project_id, team_id, last_name";
