...
try {
    ...
    $sql5 = "SELECT DISTINCT projects.project_id, projects.project_name, follows.follow_id, projects.image, follows.created_date FROM follows LEFT JOIN projects ON projects.project_id = follows.project_id WHERE follows.profile_id = ".$profile_id." ORDER BY follows.created_date DESC";
